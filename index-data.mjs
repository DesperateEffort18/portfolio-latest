...
async function main() {
	...
	splitText(portfolioData.about).forEach(paragraph => {
		chunks.push({
			text: `About Aditya Rakshit: ${paragraph}`,
			source: 'About Me'
		});
	});
	...
	chunks.push({
		text: `Contact information for Aditya Rakshit: Email is ${contactInfo.email}, LinkedIn profile is at ${contactInfo.linkedin}, and GitHub is ${contactInfo.github}.`,
